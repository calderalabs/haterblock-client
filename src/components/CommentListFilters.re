...
let make = (~filters: filters, ~onFiltersChange: filters => unit, _children) => {
  ...
  let onToggleStatus = (status: CommentData.Status.t) => {
    let newStatus = if (isStatusChecked(status)) {
  ...
  let onToggleSentiment = (sentiment: CommentData.Sentiment.t) => {
    let newSentiment = if (isSentimentChecked(sentiment)) {
    ...
    <div className="CommentListFilters">
      <div className="CommentListFilters__filter">
        <input
          ...
          id="published"
          _type="checkbox"
          checked=(Js.Boolean.to_js_boolean(isStatusChecked(CommentData.Status.Published)))
      ...
      <div className="CommentListFilters__filter">
        <input
          ...
          id="rejected"
          _type="checkbox"
          checked=(Js.Boolean.to_js_boolean(isStatusChecked(CommentData.Status.Rejected)))
      ...
      <div className="CommentListFilters__filter">
        <input
          ...
          id="negative"
          _type="checkbox"
          checked=(Js.Boolean.to_js_boolean(isSentimentChecked(CommentData.Sentiment.Negative)))
          onChange=(_event => onToggleSentiment(CommentData.Sentiment.Negative))
        />
      ...
      <div className="CommentListFilters__filter">
        <input
          ...
          id="neutral"
          _type="checkbox"
          checked=(Js.Boolean.to_js_boolean(isSentimentChecked(CommentData.Sentiment.Neutral)))
          onChange=(_event => onToggleSentiment(CommentData.Sentiment.Neutral))
        />
      ...
      <div className="CommentListFilters__filter">
        <input
          ...
          id="positive"
          _type="checkbox"
          checked=(Js.Boolean.to_js_boolean(isSentimentChecked(CommentData.Sentiment.Positive)))
          onChange=(_event => onToggleSentiment(CommentData.Sentiment.Positive))
        />
